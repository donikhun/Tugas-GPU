...
#include "glm.h"
#include "materials.h"
#pragma comment( linker, "/entry:\"mainCRTStartup\"" ) // set theentry point to be main()
...
spotlight_display(void)
{
	...
	drawstr(10, spot_exponent.y, "GLint spot_exponent =""spot_cutoff = ");
	...
	if (!selection) {
		glColor3ub(255, 255, 0);
		drawstr(10, 525,"Click on the arguments and move the mouse to modify values.");
	}
	glutSwapBuffers();
}
void
